// COMPILE : gcc p_exec.c -o 2Aoutput
// EXECUTE : ./2Aoutput
...
void main() {
    ...
    if(child == -1) {
        ...
        // Calling child proces on top of parent (overriding)
        execv("./binary", buffer);

        printf("\n\n [NOTE] CHILD EXECUTED SUCCESSFULLY \n\n");
        ...
        wait(NULL);
        printf("\n\n [NOTE] Parent executed successfully \n\n");
    }
...
// 	else if (child == 0) {
// 		printf("\n\n\nGreetings from the child process!");
